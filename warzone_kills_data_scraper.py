...
for num in range(num, 24941):    # A for loop that counts up to 23309, which is the number of pages of data I need.
    ...
    with open('C:/Users/dpowe_4rzki43/OneDrive/Desktop/Warzone_CSV_Files/warzone_kills.csv', 'a+') as outcsv:
